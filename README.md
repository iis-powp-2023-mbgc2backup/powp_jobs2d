...
Rozwiązanie zadań laboratoryjnych zgłasza się za pomocą Pull Request (PR) oraz wiadomości (mechanizm: zadanie platformy wikamp) do prowadzącego zajęcia zawierającej link do PR wraz z odpowiedziami na wybrane pytania z instrukcji i diagramami UML (w postaci graficznej). 
