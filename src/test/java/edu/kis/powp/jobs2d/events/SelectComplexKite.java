...
public class SelectComplexKite implements ActionListener {
    ...
    private ComplexCommand complexKite = new ComplexCommand();
    private CommandFactory kiteFactory = new CommandFactory();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        drawComplexKite.addCommand(new CommandFactory().makeKite(driverManager.getCurrentDriver()));
    }
}
